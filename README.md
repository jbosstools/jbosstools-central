...
_=JBoss Central_ is part of [JBoss Tools](http://jboss.org/tools) from
...
and then clone your fork:
    ...
    $ git clone git@github.com:<you>/=jbosstools-central.git
...
To build _=JBoss Central_ requires specific versions of Java and
...
_=JBoss Central_ is open source, and we welcome anybody that wants to
