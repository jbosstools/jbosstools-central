...
/**
 * The <code>ChromeURLTransfer</code> class fixes dropping a URL from Chrome into Eclipse on Linux
 *  
 *  @author snjeza
 *  
...
public class LinuxURLTransfer extends ByteArrayTransfer {
	...
	/**
	 * Returns the singleton instance of the ChromeURLTransfer class.
	 *
	 * @return the singleton instance of the ChromeURLTransfer class
	 */
