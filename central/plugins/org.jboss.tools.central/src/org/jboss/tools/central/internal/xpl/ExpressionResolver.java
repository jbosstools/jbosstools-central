 ...
 *
 * Syntax:
 *   Given property foo=bar
 *   ${foo} => bar
 *   ${empty:default} => default
 *   ${empty,foo:default} => bar
 *  
 * Based on ValueExpressionResolver from jboss-dmr.
 * 
...
public class ExpressionResolver {
     ...
     */
    public static final ExpressionResolver DEFAULT_RESOLVER = new ExpressionResolver();
	private Properties properties;

    /**
     * Construct a new instance using system properties to resolve variables.
     */
    public ExpressionResolver() {
    }

    /**
     * Construct a new instance with a specific set of properties
     * 
     *  @param properties properties to use for lookup, if null system properties will be used.
     */
