		...
		if (object instanceof INewWizard) {
	          ...
	          if (wizard instanceof AbstractJBossCentralProjectWizard) {
	        	  if ( ((AbstractJBossCentralProjectWizard)wizard).getProjectExample() == null) {
	        		  new MyErrorDialogDialog(getDisplay().getActiveShell()).open();
	        		  return;
	        	  }
	          }
...
private class MyErrorDialogDialog extends MessageDialog {
		
		public MyErrorDialogDialog(Shell parentShell) {
